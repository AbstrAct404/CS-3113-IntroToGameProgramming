...
// Tutorial Level A: Upgrade Training
// Simple map with 10 training bots (no AI) to teach upgrade system
...
public:
    ...
    static constexpr int TRAINING_BOT_COUNT = 6;
    ...
    // Weapon upgrade stats (same as before)
